...
final class VelocityEventBus implements EventManager {
  ...
  static final Set<Class<?>> FIRED = Set.of(ProxyInitializeEvent.class, ProxyShutdownEvent.class, LoginEvent.class,
      ...
      com.velocitypowered.api.event.connection.PreTransferEvent.class, com.velocitypowered.api.event.player.TabCompleteEvent.class,
      com.velocitypowered.api.event.player.CookieReceiveEvent.class,
      com.velocitypowered.api.event.player.CookieStoreEvent.class, com.velocitypowered.api.event.player.CookieRequestEvent.class,
      com.velocitypowered.api.event.player.PlayerModInfoEvent.class, com.velocitypowered.api.event.query.ProxyQueryEvent.class,
      com.velocitypowered.api.event.player.PlayerChannelRegisterEvent.class, com.velocitypowered.api.event.player.PlayerChannelUnregisterEvent.class,
      com.velocitypowered.api.event.command.PostCommandInvocationEvent.class,
      com.velocitypowered.api.event.command.PlayerAvailableCommandsEvent.class,
      com.velocitypowered.api.event.connection.ConnectionHandshakeEvent.class,
      com.velocitypowered.api.event.player.configuration.PlayerEnterConfigurationEvent.class,
      ...
      com.velocitypowered.api.event.player.ServerResourcePackSendEvent.class,
      com.velocitypowered.api.event.player.ServerResourcePackRemoveEvent.class);
