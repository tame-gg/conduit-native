...
/**
 * Adventure components as Conduit Text. Keeps what Text can carry -- colour (hex snapped to the
 * nearest named colour), bold, italic, run-command clicks and text hovers -- and flattens anything
 * else (translatable, keybind, score, selector components) to its plain rendering.
 */
final class Texts {
  private Texts() {}
