...
public enum PacketKind {
  ...
  /** 1.20.2 only: the single Resource Pack Send, as in Play. 1.20.3 replaced it with Push and Pop. */
  CONFIGURATION_RESOURCE_PACK_SEND,
  /** 1.20.3+: add one resource pack, named by UUID. */
  CONFIGURATION_RESOURCE_PACK_PUSH,
  /** 1.20.3+: remove one resource pack by UUID, or every one. */
  CONFIGURATION_RESOURCE_PACK_POP,
  /** The client's answer to a resource pack; from 1.20.3 it names the pack. */
