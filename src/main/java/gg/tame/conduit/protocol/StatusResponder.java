...
/** Local server-list status implementation for protocol 765. */
public final class StatusResponder {
  ...
  public static byte[] response(ProtocolDefinition protocol, byte[] request, String description) throws IOException {
    ...
    String json = "{\"version\":{\"name\":\"Conduit " + protocol.version().displayName() + "\",\"protocol\":" + protocol.version().number() + "},\"players\":{\"max\":0,\"online\":0},\"description\":{\"text\":\"" + jsonEscape(description) + "\"}}";
