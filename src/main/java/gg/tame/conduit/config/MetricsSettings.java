 ...
 */
public record MetricsSettings(Optional<InetSocketAddress> prometheusAddress) {
  public MetricsSettings {
    prometheusAddress = prometheusAddress == null ? Optional.empty() : prometheusAddress;
  }
  public static MetricsSettings defaults() { return new MetricsSettings(Optional.empty()); }
}
