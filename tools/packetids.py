...
KINDS: dict[tuple[str, str, str], list[str]] = {
    ...
    # Resource packs: one Send per pack through 1.20.2; 1.20.3 replaced it with Push and Pop,
    # which name each pack by UUID. They are different packets, so each is its own kind.
    (STATE_PLAY, TO_CLIENT, "PLAY_RESOURCE_PACK_SEND"): ["resource_pack_send"],
    (STATE_PLAY, TO_CLIENT, "PLAY_RESOURCE_PACK_PUSH"): ["add_resource_pack"],
    (STATE_PLAY, TO_CLIENT, "PLAY_RESOURCE_PACK_POP"): ["remove_resource_pack"],
    (STATE_CONFIG, TO_CLIENT, "CONFIGURATION_RESOURCE_PACK_SEND"): ["resource_pack_send"],
    (STATE_CONFIG, TO_CLIENT, "CONFIGURATION_RESOURCE_PACK_PUSH"): ["add_resource_pack"],
    (STATE_CONFIG, TO_CLIENT, "CONFIGURATION_RESOURCE_PACK_POP"): ["remove_resource_pack"],
    (STATE_CONFIG, TO_SERVER, "CONFIGURATION_RESOURCE_PACK_STATUS"): ["resource_pack_receive"],
